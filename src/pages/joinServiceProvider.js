...
class joinServiceProvider extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
          ...
          <section id="contact" class="contact">
            <div class="container">
              ...
              >
                ...
                <p>
                  I’m interested to partner and establish an Integrated Booking
                  and Delivery Services in a City/Municipality using ARIBA
                  gateway portal.
                </p>
              </div>
                    ...
                    <div class="php-email-form">
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                          <h5>City/Municipality Planning to Operate:</h5>
                          <input
                            type="text"
                            class="form-control"
                            name="city"
