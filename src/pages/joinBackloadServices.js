...
class joinBackloadServices extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
          ...
          <section id="contact" class="contact">
            <div class="container">
              <div
                ...
                style={{ marginTop: 60 }}
              >
                <h2>Join For Truckers/Backload Services</h2>
                <p>
                  I’m interested to partner as Truckers/Backload Services using
                  ARIBA gateway portal.
                </p>
              </div>
...
export default joinBackloadServices;
