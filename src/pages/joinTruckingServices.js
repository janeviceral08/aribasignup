...
class joinTruckingServices extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
  ...
  onSubmit = () => {
    const { email, city, cname, mobile, fb, Business } = this.state;
    if (cname === "") {
          ...
          <section id="contact" class="contact">
            <div class="container">
              <div
                ...
                style={{ marginTop: 60 }}
              >
                <h2>Join For Tracking Services</h2>
                <p>
                  I’m interested to partner my Trucking Services using ARIBA
                  gateway portal.
                </p>
              </div>
                  ...
                  {this.state.loading === true ? (
                    ...
                    <div class="php-email-form">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                          <h5>Business name if available:</h5>
                          <input
                            type="text"
                            class="form-control"
                            name="Business"
                            id="Business"
                            placeholder="Business name if available"
                            onChange={this.handleChangeText}
                          />
                        </div>
                      </div>
...
export default joinTruckingServices;
