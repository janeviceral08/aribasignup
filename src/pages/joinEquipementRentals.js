...
class joinEquipementRentals extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
          ...
          <section id="contact" class="contact" style={{backgroundColor:'black'}}>
            <div class="container">
              <div
                ...
                style={{ marginTop: 60 }}
              >
                <h2>Join For Equipment Rentals</h2>
                <p>
                  I’m interested to partner my Equipment Rentals using ARIBA
                  gateway portal.
                </p>
              </div>
...
export default joinEquipementRentals;
