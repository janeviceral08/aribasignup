...
class joinCarRental extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
          ...
          <section id="contact" class="contact">
            <div class="container">
              <div
                ...
                style={{ marginTop: 60 }}
              >
                <h2>Join For Car Rental</h2>
                <p>
                  I’m interested to partner my Car Rental Services using ARIBA
                  gateway portal.
                </p>
              </div>
