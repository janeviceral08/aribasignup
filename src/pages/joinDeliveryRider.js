...
class joinDeliveryRider extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cname: "",
  ...
  onSubmit = () => {
    const { email, city, cname, mobile, fb, License, Expiry } = this.state;
    if (cname == "") {
    ...
    if (License === "") {
      cogoToast.error("Enter your license number");
      return;
    }
    if (Expiry === "") {
      cogoToast.error("Enter your expiration date");
      return;
    }
          ...
          <section id="contact" class="contact">
            <div class="container">
              <div
                ...
                style={{ marginTop: 60 }}
              >
                <h2>Join As Delivery Rider</h2>
                <p>
                  I’m interested to partner as a Delivery Rider using ARIBA
                  gateway portal.
                </p>
              </div>
...
export default joinDeliveryRider;
